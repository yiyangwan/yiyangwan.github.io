...
\position{Senior Applied Scientist | Science Lead, IP Infringement Detection}{Dec 2025 - Present}
\begin{cvitems}

\item
{\textbf{Science lead and primary POC for Amazon's end-to-end IP infringement detection pipeline}, owning the multimodal infringement detection stack and upstream brand detection models that operate at \textbf{Amazon catalog scale} and support automated enforcement decisions across Brand Protection.}

\item
{\textbf{Own the science and model strategy for a core foundation model in Amazon Brand Protection}, setting the technical roadmap across multimodal reasoning, model architecture, continued pre-training, post-training, evaluation, and efficient inference.}

\item
{\textbf{Lead cross-functional model launches across Science, SDE, Data, and Audit/Program teams}, defining model-readiness and automated-enforcement standards, resolving science-to-production gaps, and driving models from research through large-scale production deployment.}

\item
{\textbf{Drive organization-level business impact by improving infringement detection quality and operating efficiency}, delivering \textbf{33\% fewer false positives, a 28-point catch-rate improvement on the hardest cases, and 3$\times$ lower serving cost} while advancing broader Brand Protection goals.}
...
\item 
    ...
    \hfill\href{https://ieeexplore.ieee.org/abstract/document/8684317}{[\textbf{Paper}]}}
\item
    ...
    \hfill\href{https://ieeexplore.ieee.org/abstract/document/8984345}{[\textbf{Paper}]}}
\item 
    ...
    \hfill\href{https://ieeexplore.ieee.org/abstract/document/9264885}{[\textbf{Paper}]}}
\item
    ...
    \hfill\href{https://arxiv.org/pdf/2110.14078.pdf}{[\textbf{Paper}]}}
\item
    {\textbf{``A Dynamic Deep Reinforcement Learning-Bayesian Framework for Anomaly Detection."}~ IEEE Transactions on Intelligent Transportation Systems \hfill\href{https://www.researchgate.net/profile/Jeremy-Watts/publication/349376559_A_Dynamic_Deep_Reinforcement_Learning-Bayesian_Framework_for_Anomaly_Detection/links/602d3825299bf1cc26d21a91/A-Dynamic-Deep-Reinforcement-Learning-Bayesian-Framework-for-Anomaly-Detection.pdf}{[\textbf{Paper}]}}
\item 
    {\textbf{``Anomaly Detection and String Stability Analysis in Connected Automated Vehicular Platoons."}~ Transportation Research Part C\hfill\href{https://www.researchgate.net/publication/362382000_Anomaly_Detection_and_String_Stability_Analysis_in_Connected_Automated_Vehicular_Platoons}{[\textbf{Paper}]}}
\item
    {\textbf{``Improving Transit in Small Cities through Collaborative and Data-driven Scenario Planning."}~ Case Studies on Transport Policy \hfill\href{https://www.sciencedirect.com/science/article/pii/S2213624X23000111}{[\textbf{Paper}]}}
\item
